...
+
----
# pmval --archive /var/log/pcp/pmlogger/{foreman-example-com}/20180816.00.10 \
...
[options="nowrap", subs="verbatim,quotes,attributes"]
----
# pmval --archive /var/log/pcp/pmlogger/_{foreman-example-com}/20180816.00.10_ \
  -d -t 2sec \
...
[options="nowrap", subs="verbatim,quotes,attributes"]
----
# pmlogsummary /var/log/pcp/pmlogger/_{foreman-example-com}/20180816.00.10_ \
  -HlfiImM \
  -S @14:00 \
  -T @14:30 \
...
[options="nowrap", subs="verbatim,quotes,attributes"]
----
# pcp --archive /var/log/pcp/pmlogger/_{foreman-example-com}/20180816.00.10_ \
  -S @14:00 \
  atop
----